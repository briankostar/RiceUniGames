    ...
    def draw(self, canvas):
        ...
        if self.animated:
            ...
            canvas.draw_image(explosion_image, 
                    [EXPLOSION_CENTER[0] + explosion_index * EXPLOSION_SIZE[0], 
                     EXPLOSION_CENTER[1]], 
...
def draw(canvas):
    global time, started, lives, score, rock_group, timer
...
def start():
    global my_ship, rock_group, missile_group, explosion_group, score, lives, timer
    lives = 3
    score = 0
...
#draw each sprite in the group of set        
...
#check if any element in the group of set is colliding with the other object   
...
def group_group_collide(group1, group2):
    #returns number of collisions, and also remove sprite from 1st group w collision
    collisions = 0
